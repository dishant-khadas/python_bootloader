...
class FirmwareUpdatePage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Status Label (larger font for better visibility, black text)
        self.status_label = ttk.Label(container, text="Please wait...", font=lm.font(20), foreground="black", wraplength=lm.scaled(400), justify="center")
        self.status_label.pack(pady=lm.scaled(20))
        ...
        try:
            ...
            for line in iter(self.process.stdout.readline, ''):
                if line:
                    ...
                    # If output is a number (percentage), add % symbol
                    try:
                        float(output_text)
